...
#define INDEX_TYPE(__i)         SIZE_TYPE(__i)
...
/*
 *    This must defined globally by the user
 */
typedef struct {
 ...
 */
ARRAY_TYPE(array_create)(SIZE_TYPE(elt_size), SIZE_TYPE(n), void (*_free)(void *));
 ...
 * called.
 */
ARRAY_TYPE(array_seize_buffer)(PTR_TYPE(*buffer), SIZE_TYPE(bufsize), SIZE_TYPE(elt_size), SIZE_TYPE(n), void (*_free)(void *));
 ...
 * safely be used.
 */
ARRAY_TYPE(array_borrow_buffer)(PTR_TYPE(*buffer), SIZE_TYPE(bufsize), SIZE_TYPE(elt_size), SIZE_TYPE(n), void (*_free)(void *));
 ...
 * allocated buffer.
 */
PTR_TYPE(array_extract)(RDONLY_ARRAY_TYPE(src), SIZE_TYPE(start), SIZE_TYPE(end));
 ...
 */
ARRAY_TYPE(array_pull)(RDONLY_ARRAY_TYPE(src), SSIZE_TYPE(start), SSIZE_TYPE(end));
 ...
 */
NONE_TYPE(array_tipex)(ARRAY_TYPE(self), SIZE_TYPE(off), RDONLY_PTR_TYPE(src), SIZE_TYPE(n));
 ...
 * potitions 'p'.
 */
BOOL_TYPE(array_inject)(ARRAY_TYPE(self), SIZE_TYPE(p), RDONLY_PTR_TYPE(src), SIZE_TYPE(n));
 ...
 */
ARRAY_TYPE(array_filter)(RDONLY_ARRAY_TYPE(self), bool (*callback)(RDONLY_PTR_TYPE(elem)));
...
__attr_pure PTR_TYPE(array_find)(ARRAY_TYPE(self), bool (*callback)(RDONLY_PTR_TYPE(elem)));

/* Behaves the same as 'find' except it returns an index (that can be used with
 * 'at'), or -1 if no element was found.
 */
__attr_pure SSIZE_TYPE(array_find_index)(ARRAY_TYPE(self),
                                 bool (*callback)(RDONLY_PTR_TYPE(elem)));

/* Behaves the same as 'find' expect it starts the search from the end.
 */
__attr_pure PTR_TYPE(array_rfind)(ARRAY_TYPE(self), bool (*callback)(RDONLY_PTR_TYPE(elem)));
 ...
 */
__attr_pure PTR_TYPE(array_rfind_index)(ARRAY_TYPE(self), bool (*callback)(RDONLY_PTR_TYPE(elem)));
